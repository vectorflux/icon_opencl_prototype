						   ...
						   double * z_dexner_dz_c)
{
	...
	CheckCL( clSetKernelArg(ocl.kernel_exner3a,11, sizeof(double)*(*nlev), NULL) );
	...
	CheckCL( clSetKernelArg(ocl.kernel_exner3b,11, sizeof(double)*(*nlevp1), NULL) );
						   ...
						   double * z_dexner_dz_c)
{
	...
	CheckCL( clSetKernelArg(ocl.kernel_theta2,21, sizeof(double)*(*nlev), NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_theta2,22, sizeof(double)*(*nlev), NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_theta2,23, sizeof(double)*(*nlev), NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_theta2,24, sizeof(double)*(*nlev), NULL) );
						  ...
						  double * z_hydro_corr)
{
	...
	CheckCL( clSetKernelArg(ocl.kernel_grad2,17, sizeof(int)*2, NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_grad2,18, sizeof(double)*2, NULL) );
							...
							double * z_vn_avg)
{
	...
	CheckCL( clSetKernelArg(ocl.kernel_vn_avg,12, sizeof(double)*5, NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_vn_avg,13, sizeof(int)*4, NULL) );
							 ...
							 double * z_concorr_e)
{
	...
	CheckCL( clSetKernelArg(ocl.kernel_vn_half1,13, sizeof(double)*(*nlev), NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_vn_half1,14, sizeof(double)*(*nlev), NULL) );
							  ...
							  double * theta_v_nnew)
{
	...
	CheckCL( clSetKernelArg(ocl.kernel_endphase3,19, sizeof(double)*(*nlevp1), NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_endphase3,20, sizeof(double)*(*nlevp1), NULL) );
	...
	CheckCL( clSetKernelArg(ocl.kernel_endphase5b,12, sizeof(double)*(*nlevp1), NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_endphase5b,13, sizeof(double)*(*nlevp1), NULL) );
	...
	CheckCL( clSetKernelArg(ocl.kernel_endphase6,12, sizeof(double)*(*nlev), NULL) );
	...
	CheckCL( clSetKernelArg(ocl.kernel_endphase7,11, sizeof(double)*(*nlev), NULL) );
	...
	CheckCL( clSetKernelArg(ocl.kernel_endphase9a,14, sizeof(double)*(*nlevp1), NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_endphase9a,15, sizeof(double)*(*nlevp1), NULL) );
	...
	CheckCL( clSetKernelArg(ocl.kernel_endphase9b,13, sizeof(double)*(*nlevp1), NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_endphase9b,14, sizeof(double)*(*nlevp1), NULL) );
...
{	
	...
	if (*istep == 1)
	{
		...
		CheckCL( clSetKernelArg(ocl.kernel_step1a,12, sizeof(double)*(*nlev), NULL) );
						   ...
						   double * z_ddxn_ekin_e)
{
	...
	CheckCL( clSetKernelArg(ocl.kernel_phase2,18, sizeof(int)*2, NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_phase2,19, sizeof(int)*2, NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_phase2,20, sizeof(double)*2, NULL) );
						   ...
						   double * z_w_con_c_full)
{
	...
	CheckCL( clSetKernelArg(ocl.kernel_phase3a, argIdx++, sizeof(int)*3, NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_phase3a, argIdx++, sizeof(double)*3, NULL) );
	...
	*/
	...
	CheckCL( clSetKernelArg(ocl.kernel_phase3c, 9, sizeof(double)*(*nlevp1), NULL) );
						   ...
						   double * ddt_vn_adv)
{
	...
	CheckCL( clSetKernelArg(ocl.kernel_phase4,22, sizeof(int)*2, NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_phase4,23, sizeof(int)*2, NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_phase4,24, sizeof(double)*2, NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_phase4,25, sizeof(double)*(*nlevp1), NULL) );
						   ...
						   double * ddt_w_adv)
{
	...
	CheckCL( clSetKernelArg(ocl.kernel_phase5,13, sizeof(double)*(*nlevp1), NULL) );
							 ...
							 int * localEnd)
{
	...
	CheckCL( clSetKernelArg(ocl.kernel_div_tri,12, sizeof(int)*3, NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_div_tri,13, sizeof(double)*3, NULL) );
										   ...
										   int * elev /*ok*/)
{
	...
	CheckCL( clSetKernelArg(ocl.kernel_rbf_vec_interpol_edge, argIdx++, sizeof(int)*4, NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_rbf_vec_interpol_edge, argIdx++, sizeof(double)*4, NULL) );
										...
										double * p_edge_out, int * nameIdx_out, bool * bOnGPU_out)
{
	...
	CheckCL( clSetKernelArg(ocl.kernel_cells2edges_scalar, 15, sizeof(int)*2, NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_cells2edges_scalar, 16, sizeof(double)*2, NULL) );
											...
											double * p_cell_out /*ok*/, int * nameIdx_out, bool * bOnGPU_out)
{
	...
	CheckCL( clSetKernelArg(ocl.kernel_edges2cells_scalar_tri,15, sizeof(int)*3, NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_edges2cells_scalar_tri,16, sizeof(double)*3, NULL) );
							  ...
							  double * avg_psi_c /*ok*/, int * nameIdx_out, bool * bOnGPU_out)
{
	...
	CheckCL( clSetKernelArg(ocl.kernel_cell_avg,14, sizeof(int)*3, NULL) );
	CheckCL( clSetKernelArg(ocl.kernel_cell_avg,15, sizeof(double)*4, NULL) );
