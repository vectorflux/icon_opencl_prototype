...
!!  REAL(wp), PARAMETER :: grav  = 9.80616_wp       ! [m/s2] av. gravitational acceleration
  ...
  !> H2O
  !! - gas
  REAL(wp), PARAMETER :: rv    = 461.51_wp        !> [J/K/kg] gas constant
  ...
  ! parameters from Bjorn
  ! Universal constants
  REAL(wp), PARAMETER :: api   = 3.14159265358979323846_wp ! pi
  REAL(wp), PARAMETER :: asqrt2= 1.41421356237309504880_wp
! REAL(wp), PARAMETER :: ar    = 8.314e3_wp       ! universal gas constant in J/K/kmol
  REAL(wp), PARAMETER :: ap0   = 101325._wp       ! Standard pressure in Pa
...
! s_lake, s_licetemp, s_sicetemp, meltpond, meltpond_ice, update_albedo_ice_meltpond
  ...
  REAL(wp), PARAMETER :: hcapmix   = rhoh2o*cpliq*dmix     ! heat capacity of lake mixed layer in J/K/m2
