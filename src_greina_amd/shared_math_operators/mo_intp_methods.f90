...
!!
!!
MODULE mo_intp_methods
!-------------------------------------------------------------------------
USE mo_kind,                ONLY: wp
USE mo_exception,           ONLY: finish
USE mo_impl_constants,      ONLY: min_rlcell, min_rledge, min_rlvert
USE mo_model_domain,        ONLY: t_patch
USE mo_global_variables,    ONLY: nproma, nlev, i_cell_type, ltimer
...
PUBLIC :: verts2edges_scalar, cells2edges_scalar, edges2verts_scalar,   &
          ...
          & verts2cells_scalar, cell_avg, edges2edges_scalar, t_int_state
CONTAINS
