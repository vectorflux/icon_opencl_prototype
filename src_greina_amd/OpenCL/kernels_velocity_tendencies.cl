...
{
	__private double line_vn[NLEV_];
	const int jb = i_startblk + get_global_id(0);
	const int je = localStart[get_global_id(0)] + get_global_id(2);
...
{
	__private int line_idx[2];
	__private int line_idx2[2];
	__private double line_c_lin_e[2];
	const int jb = i_startblk + get_global_id(0);
	const int je = localStart[get_global_id(0)] + get_global_id(2);
...
{
	__private double line_w_con[NLEV_P1];
	const int jb = i_startblk + get_global_id(0);
	const int jc = localStart[get_global_id(0)] + get_global_id(2);
	const int jk = get_global_id(1);
...
{
	__private int line_ividx[2];
	__private int line_icidx[2];
	__private double line_c_lin_e[2];
	__private double line_vn_half[NLEV_P1];
...
{
	__private double line_w[NLEV_P1];
	const int jb = i_startblk + get_global_id(0);
	const int jc = localStart[get_global_id(0)] + get_global_id(2);
	const int jk = 1 + get_global_id(1);
